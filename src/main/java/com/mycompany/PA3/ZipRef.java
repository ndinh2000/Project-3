...
//            BufferedReader br=new BufferedReader(new FileReader(String.valueOf(path.getParent())));
            ...
            BufferedReader br=new BufferedReader(new FileReader("C:\\Users\\YaseminTurkkan\\Desktop\\124\\Project-3\\src\\main\\webapp\\tax_rates2.csv"));
            String line = null;
            while((line=br.readLine()) != null)
            {
                String str[] = line.split(",");
                map.put(str[1],str[0]); //zip,state
//                map.put(new String[]{str[1],str[0]},str[3]);
            }
...
//                if ((Integer.toString(zipI)).equals(pair[0]) ) {
//                    out.write(pair[1]+", "+map.get(pair));
//                }
//            }

//            out.write(" , ");
            for(String m_zip: map.keySet())
            {
                if((Integer.toString(zipI)).equals(m_zip))
                {
                    out.write(map.get(m_zip));
//                    out.write(map.get(pair));
//                    break;
                }
            }
